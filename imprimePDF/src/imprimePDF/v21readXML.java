...
//				}
		...
		//	System.out.println(_ident);
			...
			Node nNode_CustomerAssignedAccountID = nList_CustomerAssignedAccountID.item(12);
			...
			Node nNode_CustomerAssignedAccountID_r = nList_CustomerAssignedAccountID_r.item(15);
			...
			if (Cabecera.get_ruc_receptor().equals("1000")) {
				// cbc:CustomerAssignedAccountID "RUC DEL RECEPTOR"
				NodeList nList_CustomerAssignedAccountID_r2 = doc.getElementsByTagName("cbc:ID");
				Node nNode_CustomerAssignedAccountID_r2 = nList_CustomerAssignedAccountID_r2.item(14);
				Cabecera.set_ruc_receptor(nNode_CustomerAssignedAccountID_r2.getTextContent());
				System.out.println("RUC del Receptor_ _ _ _ _ _ _ _: " + Cabecera.get_ruc_receptor());
